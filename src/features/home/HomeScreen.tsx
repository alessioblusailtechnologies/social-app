...
import { HOME_HORIZON_DAYS, homeSummary, homeTasks, type HomeTask, type HomeTaskKind } from '@/domain/home';
import { FORMAT_LABELS } from '@/domain/idea';
import type { PlanSlot } from '@/domain/plan';
import { completeness } from '@/domain/sections';
import { BrandAvatar } from '@/features/brand-editors';
import { BalancePanel, SlotCard } from '@/features/plan/PlanParts';
import { addDays, formatWeekdayLong, formatWeekdayShort, startOfWeek, today } from '@/lib/dates';
