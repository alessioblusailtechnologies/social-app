...
import { ideaPreferences, SIGNAL_LABELS, type Idea, type IdeaDraft, type IdeaFormat, type IdeaSource } from '@shared/domain/idea';
import { selectedChannels } from '@shared/domain/plan';
import { createStepLog, IDEAS_STEPS, THINKING_STEP } from '@shared/services/ai-steps';
import { describeLink } from '@shared/mock/idea-generator';
