...
import type { BrandLine, BrandTemplate, BrandVideo, ImageStyle, TemplateFont, VisualExample } from '@shared/domain/brand';
import { channelName, IMAGE_STYLES } from '@shared/domain/catalog';
import { cleanTemplates, exampleChannels, sameReferences, TEMPLATE_FIELDS, templateFallback } from '@shared/domain/line';
import {
  aspectFor,
  brandKit,
  CARD_LIMITS,
...
import { createStepLog, VIDEO_PROFILE_STEPS, VISUAL_STEPS } from '@shared/services/ai-steps';
import type { OnAiSteps, VisualStyle, VisualStyleRequest } from '@shared/services/types';
