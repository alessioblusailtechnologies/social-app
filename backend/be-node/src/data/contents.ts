...
import { readScene, type ChannelVariant, type Content, type ContentStatus, type ContentVisual } from '@shared/domain/content';
import type { IdeaFormat, IdeaSource } from '@shared/domain/idea';
