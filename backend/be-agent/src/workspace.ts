...
import { currentVoiceCard, type Brand, type BrandVideo, type ChannelId } from '@shared/domain/brand';
import { channelName, imageStyleLabel } from '@shared/domain/catalog';
