import type { Brand, ChannelId, Identity } from '@shared/domain/brand';
import { applyPatch } from '@shared/domain/brand';
import { channelName } from '@shared/domain/catalog';
import { channelsWaitingForVideo, channelsWithoutImage, cutKey, footageKind, readScene, videoSeconds, type Content, type VideoScene } from '@shared/domain/content';
import { sourceTitle, type Idea, type IdeaDraft, type IdeaSource, type IdeaStatus, type MaterialFile } from '@shared/domain/idea';
import {
  buildSkeleton,
  channelsWithIdea,
  fillSkeleton,
...
import { toDay, today } from '@shared/lib/dates';
...
import { generateContent, generateDirectContent, rewriteText } from '@shared/mock/content-generator';
import {
  clearDatabase,
  contentsCollection,
  ideasCollection,
...
import { draftsFromSource, generateIdeaDrafts } from '@shared/mock/idea-generator';
import { sampleCutout, samplePhoto } from '@shared/mock/sample-images';
