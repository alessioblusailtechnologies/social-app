...
import { BEST_TIMES, channelsWithIdea, rankIdeasForSlot, selectedChannels, type PlanSlot } from '@shared/domain/plan';
import { ChannelMark } from '@/features/brand-editors';
import { addDays, formatWeekdayLong, formatWeekdayShort, today } from '@shared/lib/dates';
import { useIdeas, usePlan, useRemoveSlot, useUpdateSlot } from '@/services/queries';
import type { SlotPatch } from '@shared/services/types';
