...
import { CHANNELS, channelName } from '@shared/domain/catalog';
import { channelsWithIdea, rankIdeasForSlot, selectedChannels, type SlotDraft } from '@shared/domain/plan';
import { ChannelMark } from '@/features/brand-editors';
import { addDays, formatRange, formatWeekdayLong, startOfWeek, today } from '@shared/lib/dates';
