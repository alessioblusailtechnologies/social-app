...
import { currentVoiceCard, isConnected, type Brand, type ChannelId } from '@shared/domain/brand';
import { CHANNEL_FORMATS, channelName } from '@shared/domain/catalog';
import {
  CHANNEL_LIMITS,
...
import { FORMAT_LABELS, sourceTitle, type IdeaFormat, type IdeaSource } from '@shared/domain/idea';
import type { PlanSlot } from '@shared/domain/plan';
import { channelsWaitingForVisual, needsMedia, stageAspect } from '@shared/domain/visual';
import { DayTimePicker } from '@/features/plan/SlotPanels';
import { VisualPanel } from '@/features/visual/VisualPanel';
import { formatWeekdayShort } from '@shared/lib/dates';
