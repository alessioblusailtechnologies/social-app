...
import { isConnected, type Brand, type ChannelId } from '@shared/domain/brand';
import { channelName } from '@shared/domain/catalog';
import { channelsWaitingForVideo, channelsWithoutImage, type Content } from '@shared/domain/content';
import { FORMAT_LABELS, type IdeaFormat } from '@shared/domain/idea';
import { nextFreeDay, SLOT_STATUS_LABELS, type PlanSlot } from '@shared/domain/plan';
import { channelsWaitingForVisual, stageAspect } from '@shared/domain/visual';
...
import { formatWeekdayShort, today } from '@shared/lib/dates';
import type { JobKind } from '@shared/services/types';
import {
  useContentJob,
  useIdeas,
  usePlan,
