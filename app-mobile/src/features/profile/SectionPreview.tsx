...
import { currentVoiceCard, isConnected, type Brand, type SectionKey } from '@shared/domain/brand';
import { CHANNELS } from '@shared/domain/catalog';
import { identityLine, sectionCopy, sectionSummary } from '@shared/domain/sections';
