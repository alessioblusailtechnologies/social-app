...
import { applyPatch, type Brand, type BrandDraft, type SectionKey, type SectionPatch } from '@shared/domain/brand';
import { sectionCopy, sectionError } from '@shared/domain/sections';
