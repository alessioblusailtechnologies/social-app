import type { Brand, ChannelId, ImageStyle } from '@shared/domain/brand';
import { currentVoiceCard } from '@shared/domain/brand';
import { withBrandTemplates } from '@shared/domain/line';
import { proposeDesign, type VisualKind, type VisualProposal } from '@shared/domain/visual';
import {
  CHANNEL_LIMITS,
  numbersToDigits,
  type CarouselSlide,
...
import type { Idea, IdeaFormat, IdeaSource } from '@shared/domain/idea';
import { createRng, pick, seedFromString } from '@shared/lib/random';
