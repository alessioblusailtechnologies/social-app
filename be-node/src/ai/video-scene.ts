...
import { SCENE_SOURCE_LABELS, readScene, type Content, type VideoScene } from '@/domain/content';
import { THINKING_STEP, VIDEO_SCENE_STEPS, createStepLog } from '@/services/ai-steps';
